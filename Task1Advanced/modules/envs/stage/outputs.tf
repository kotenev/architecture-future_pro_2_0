...
output "ai_server" {
  description = "AI Server information"
  value       = module.ai_server.instance_info
}

output "ai_ssh_connection" {
  description = "SSH connection string for AI server"
  value       = module.ai_server.ssh_connection
}
