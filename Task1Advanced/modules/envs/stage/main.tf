...
module "dwh_server" {
  ...
  vm_name     = "dwh-server"
  environment = var.environment
  description = "Data Warehouse server for Future 2.0 - staging"
...
module "integration_server" {
  ...
  environment = var.environment
  description = "Integration bus server for Future 2.0 - staging"
...
module "bi_server" {
  ...
  vm_name     = "bi-server"
  environment = var.environment
  description = "Business Intelligence server for Future 2.0 - staging"
...
module "ai_server" {
  ...
  vm_name     = "ai-services"
  environment = var.environment
  description = "AI Services server for medical data processing - staging"
